...
public class Action {
	...
	public Action(long id_Action, String nom_action, String description_action, byte[] photo, String path_photo,
			String lieu_action, Date datedebut_action, Date datefin_action, Date datedebut_inscrit,
			Date datefin_inscrit, Boolean etat_action, Long nbmembre_action, Set<UserAction> userAction,
			Set<UserCommentaireAction> userCommentaireAction) {
		super();
	...
	public Action(long id_Action, String nom_action, String description_action,
			String lieu_action, Date datedebut_action, Date datefin_action, Date datedebut_inscrit,
			Date datefin_inscrit, Boolean etat_action, Long nbmembre_action) {
		super();
		this.id_Action = id_Action;
		this.nom_action = nom_action;
		this.description_action = description_action;
	...
	public Date getDatedebut_inscrit() {
		return datedebut_inscrit;
	}
	public void setDatedebut_inscrit(Date datedebut_inscrit) {
		this.datedebut_inscrit = datedebut_inscrit;
	}
	public Date getDatefin_inscrit() {
		return datefin_inscrit;
	}
	public void setDatefin_inscrit(Date datefin_inscrit) {
		this.datefin_inscrit = datefin_inscrit;
	}
