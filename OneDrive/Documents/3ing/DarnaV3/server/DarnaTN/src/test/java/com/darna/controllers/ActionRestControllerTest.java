...
public class ActionRestControllerTest {
	...
	private ObjectMapper objectMapper;
	 ...
	 public void testUpload_addAction() throws Exception {
		...
		Action action =new Action(3, "nom", "des","lieu",new Date(), new Date(),new Date(),new Date(), false,(long)9);
	 ...
	 public void TestPublierAction() throws Exception 
		{
		    Action action =new Action(3, "conference de presse", "des","lieu",new Date(), new Date(),new Date(),new Date(), true,(long)9);
