...
public class PublicationRestControllerTest {
	...
	/*
	@Test
	public void addPublicationAPI() throws Exception 
	{
		//Publication newpublication= new Publication(14,"Faire un don","http://www.donbyuib.com.tn/darna.html","Aidez les enfants depuis ce lien");
		...
		mockMvc.perform( MockMvcRequestBuilders
		  ...
		  .andDo(print());
	      //.andExpect(MockMvcResultMatchers.content().json("{'id_Publication': 14,'type_publication': 'Faire un don','lien_publication': 'http://www.donbyuib.com.tn/darna.html','description_publication':'En faisant un don'}"));
	}
	
	@Test
	public void TestaddPublication() throws JsonProcessingException,Exception {
		Publication newpublication= new Publication(4,"Faire un don","http://www.donbyuib.com.tn/darna.html","Aidez les enfants depuis ce lien");
		Publication savedpublication= new Publication(4,"Faire un don","http://www.donbyuib.com.tn/darna.html","Aidez les enfants depuis ce lien");
		
		Mockito.when(publicationService.addPublication(newpublication)).thenReturn(savedpublication);
		...
		mockMvc.perform(post(url)
	    		...
	    		//.andExpect(content().json("{'id_Publication': 4,'type_publication': 'Faire un don','lien_publication': 'http://www.donbyuib.com.tn/darna.html','description_publication':'En faisant un don'}"));
	}*/
	@Test
	...
	@Test
	@DisplayName("Should return the correct publication- getpublicationByid")
